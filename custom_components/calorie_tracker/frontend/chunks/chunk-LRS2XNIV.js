      ...
      <div class="modal chat-assist" @click=${this._closeChatAssist}>
        ...
        >
          ...
          <div style="flex:1;overflow-y:auto;margin-bottom:12px;border:1px solid ${a};padding:8px 6px 8px 6px;background:${s};">
            ${this._chatHistory.length===0?d`<div style="color:${t?"#aaa":"#888"};text-align:center;">No conversation yet.</div>`:this._chatHistory.map(h=>d`
                  <div style="margin-bottom:8px;">
                    <div style="font-weight:bold;color:${t?"#90caf9":"#1976d2"};">${h.role==="user"?"You":"Assistant"}:</div>
...
//# sourceMappingURL=chunk-LRS2XNIV.js.map
