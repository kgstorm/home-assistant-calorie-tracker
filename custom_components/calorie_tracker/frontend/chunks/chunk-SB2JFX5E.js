...
User request: ${i}`);let $={type:"conversation/process",text:x,conversation_id:this._conversationId,language:p.language||"en"};(o=this._selectedAgent)!=null&&o.id&&($.agent_id=this._selectedAgent.id);let v=await p.connection.sendMessagePromise($);v.conversation_id&&(this._conversationId=v.conversation_id);let A="Command processed successfully";if((y=(n=(c=v.response)==null?void 0:c.speech)==null?void 0:n.plain)!=null&&y.speech)A=v.response.speech.plain.speech;else if((h=v.response)!=null&&h.text)A=v.response.text;else if(typeof v.response=="string")A=v.response;else if(v.response&&typeof v.response=="object")if(v.response.profile){let C=v.response.profile,P=C.daily_goal-C.calories_today;A=`Logged successfully for ${C.spoken_name}. You have ${P} calories remaining today.`}else A=JSON.stringify(v.response);this._chatHistory=[...this._chatHistory,{role:"assistant",text:A}],this.dispatchEvent(new CustomEvent("refresh-daily-data",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("refresh-summary",{bubbles:!0,composed:!0}))}catch(p){this._chatHistory=[...this._chatHistory,{role:"assistant",text:`Failed to process command: ${p.message}`}]}});g(this,"_editWeight",async()=>{var l,r,o,c,n,y;let t=(l=this.log)==null?void 0:l.weight,e=(o=(r=this.profile)==null?void 0:r.attributes)==null?void 0:o.current_weight,i=(c=t!=null?t:e)!=null?c:null,a=((y=(n=this.profile)==null?void 0:n.attributes)==null?void 0:y.weight_unit)||"lbs",s=prompt(`Enter weight in ${a} (current: ${i?i+" "+a:"not set"}):`,i||"");if(s!==null&&s.trim()!==""){let h=parseFloat(s.trim());if(!isNaN(h)&&h>0)try{await this.hass.callService("calorie_tracker","log_weight",{spoken_name:this.profile.attributes.spoken_name,weight:h,timestamp:this.selectedDate||new Date().toISOString().split("T")[0]}),this.dispatchEvent(new CustomEvent("refresh-daily-data",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("refresh-summary",{bubbles:!0,composed:!0}))}catch(p){alert(`Error saving weight: ${p.message}`)}else alert("Please enter a valid weight greater than 0.")}});g(this,"_editBodyFat",async()=>{var s,l,r,o;let t=(s=this.log)==null?void 0:s.body_fat_pct,e=(r=(l=this.profile)==null?void 0:l.attributes)==null?void 0:r.body_fat_percentage,i=(o=t!=null?t:e)!=null?o:null,a=prompt(`Enter body fat percentage (current: ${i?i.toFixed(1)+"%":"not set"}):`,i||"");if(a!==null&&a.trim()!==""){let c=parseFloat(a.trim());if(!isNaN(c)&&c>=1&&c<=50)try{await this.hass.callService("calorie_tracker","log_body_fat",{spoken_name:this.profile.attributes.spoken_name,body_fat_pct:c,timestamp:this.selectedDate||new Date().toISOString().split("T")[0]}),this.dispatchEvent(new CustomEvent("refresh-daily-data",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("refresh-summary",{bubbles:!0,composed:!0}))}catch(n){alert(`Error saving body fat: ${n.message}`)}else alert("Please enter a valid body fat percentage between 1 and 50.")}});this._initializeState(),this._showMetrics=window.matchMedia("(min-width: 600px)").matches,this._mediaQuery=window.matchMedia("(min-width: 600px)"),this._userToggledMetrics=!1,this._mediaQueryListener=t=>{this._userToggledMetrics||(this._showMetrics=t.matches,this.requestUpdate())}}_initializeState(){this._editIndex=-1,this._editData=null,this._showEditPopup=!1,this._addEntryType="food",this._addData={},this._addError="",this._showAddPopup=!1,this.imageAnalyzers=[],this._showAnalyzerSelect=!1,this._showPhotoUpload=!1,this._selectedAnalyzer=null,this._photoFile=null,this._photoError="",this._photoLoading=!1,this._photoDetectedItems=null,this._showPhotoReview=!1,this._photoReviewItems=null,this._photoReviewRaw=null,this._photoReviewAnalyzer=null,this._rememberAnalyzerChoice=!1,this._cameraStarting=!1,this._cameraActive=!1,this._cameraError="",this._cameraStream=null,this._useSystemCapture=!1,this._systemCaptureReason=null,this._showChatAssist=!1,this._assistPipelines=[],this._selectedPipeline=null,this._conversationAgents=[],this._selectedAgent=null,this._chatHistory=[],this._chatInput="",this._conversationId=null,this._showMissingLLMModal=!1,this._missingLLMModalType=null,this._editError=""}connectedCallback(){super.connectedCallback(),this._mediaQuery.addEventListener("change",this._mediaQueryListener),this._showMetrics=this._mediaQuery.matches,this._handleResize=this._handleResize.bind(this),window.addEventListener("resize",this._handleResize),this._onOpenPhotoAnalysis=t=>{var e;try{let i=(e=t==null?void 0:t.detail)==null?void 0:e.modal;this._openPhotoAnalysis().then(()=>{i&&setTimeout(()=>{try{i==="food_camera"&&typeof this._selectAnalysisType=="function"?this._selectAnalysisType("food"):i==="bodyfat_camera"&&typeof this._selectAnalysisType=="function"&&this._selectAnalysisType("bodyfat")}catch(a){}},200)}).catch(()=>{})}catch(i){}},this.addEventListener("open-photo-analysis",this._onOpenPhotoAnalysis)}disconnectedCallback(){super.disconnectedCallback(),this._mediaQuery.removeEventListener("change",this._mediaQueryListener),window.removeEventListener("resize",this._handleResize),this._modalPositionInterval&&(clearInterval(this._modalPositionInterval),this._modalPositionInterval=null),this._stopCameraStream(),this.removeEventListener("open-photo-analysis",this._onOpenPhotoAnalysis)}_handleResize(){(this._showEditPopup||this._showAddPopup||this._showAnalyzerSelect||this._showAnalysisTypeSelect||this._showPhotoUpload||this._showPhotoReview||this._showMissingLLMModal||this._showChatAssist)&&this._positionModalsInContentArea()}_positionModalsInContentArea(){var t,e,i,a,s,l,r;try{let o=(t=this.renderRoot)==null?void 0:t.querySelectorAll(".modal");if(!(o!=null&&o.length))return;let c=(i=(e=this.contentBounds)==null?void 0:e.left)!=null?i:0,n=(s=(a=this.contentBounds)==null?void 0:a.width)!=null?s:window.innerWidth,y=(r=(l=this.contentBounds)==null?void 0:l.top)!=null?r:0;o.forEach(h=>{if(h.offsetParent===null)return;h.style.setProperty("background","rgba(0,0,0,0.5)","important"),h.style.setProperty("position","fixed","important"),h.style.setProperty("top","0px","important"),h.style.setProperty("bottom","0px","important"),h.style.setProperty("left","0px","important"),h.style.setProperty("right","0px","important"),h.style.setProperty("z-index","9999","important"),h.style.setProperty("display","flex","important"),h.style.setProperty("align-items","center","important"),h.style.setProperty("justify-content","center","important"),h.style.setProperty("box-sizing","border-box","important"),y>0?h.style.setProperty("padding-top",`${y}px`,"important"):h.style.setProperty("padding-top","0px","important");let p=h.querySelector(".modal-content");if(p&&n<window.innerWidth){let x=Math.min(n-32,400),$=c+(n-x)/2;p.style.position="absolute",p.style.left=`${$}px`,p.style.width=`${x}px`,p.style.right="",p.style.marginLeft="0",p.style.marginRight="0",p.style.maxWidth="400px"}else p&&(p.style.position="",p.style.left="",p.style.width="",p.style.right="",p.style.marginLeft="",p.style.marginRight="",p.style.maxWidth="")})}catch(o){console.warn("Failed to position modals:",o)}}_cleanupModalPositioning(){var t;try{let e=(t=this.renderRoot)==null?void 0:t.querySelectorAll(".modal");if(!(e!=null&&e.length))return;e.forEach(i=>{i.style.position="",i.style.left="",i.style.right="",i.style.top="",i.style.bottom="",i.style.alignItems="",i.style.justifyContent="",i.style.paddingTop="",i.style.transform="",i.style.zIndex="",i.style.background="";let a=i.querySelector(".modal-content");a&&(a.style.marginLeft="",a.style.marginRight="",a.style.maxWidth="")})}catch(e){}}_findContentContainer(){let t=this;for(;t;){let e=t.getRootNode&&t.getRootNode();if(e&&e.host){t=e.host;continue}if(t=t.parentNode,!t)break;if(t.querySelector){let i=t.querySelector(".content");if(i)return i}}return document.querySelector(".content")}updated(t){super.updated(t),["_showEditPopup","_showAddPopup","_showAnalyzerSelect","_showAnalysisTypeSelect","_showPhotoUpload","_showPhotoReview","_showMissingLLMModal","_showChatAssist"].some(a=>t.has(a))&&requestAnimationFrame(()=>{this._positionModalsInContentArea()}),t.has("_showPhotoUpload")&&(this._showPhotoUpload&&!this._useSystemCapture?(this._cameraError="",this._startCameraStream()):this._stopCameraStream())}_logToServer(t,e){try{let i=this.hass||(window==null?void 0:window.hass);i!=null&&i.callService?i.callService("system_log","write",{level:t,message:`Calorie Tracker Frontend: ${e}`}):console.warn("Cannot log to server, hass.callService not available.")}catch(i){console.error("Failed to send log to server:",i)}}_sanitizeDecimal(t){if(t==null)return"";let e=String(t).trim();e.includes(",")&&((e.match(/,/g)||[]).length===1?e=e.replace(",","."):e=e.replace(/,/g,"")),e=e.replace(/[^0-9.]/g,"");let i=e.indexOf(".");return i!==-1&&(e=e.slice(0,i+1)+e.slice(i+1).replace(/\./g,"")),/^0\d/.test(e)&&(e=e.replace(/^0+/,"0")),e}_isValidNumberStr(t){return t!=null&&t!==""&&!isNaN(Number(t))}_validateMacroCalories(t,e,i,a,s,l,r=!1){var _,x;if(!((x=(_=this.profile)==null?void 0:_.attributes)!=null&&x.track_macros)||!t||isNaN(Number(t)))return!0;let o=Number(t),c=this._isValidNumberStr(e)?Number(e)*4:0,n=this._isValidNumberStr(i)?Number(i)*4:0,y=this._isValidNumberStr(a)?Number(a)*9:0,h=this._isValidNumberStr(s)?Number(s)*7:0,p=c+n+y+h;if(p===0)return!0;let m=Math.max(o*.1,20);if(p>o+m){let $=`Calories from macros (${Math.round(p)}) exceed total calories (${o})`;return r?l&&l($):l($),!1}return!0}_closeAllModals(){this._stopCameraStream(),this._showEditPopup=!1,this._showAddPopup=!1,this._showAnalyzerSelect=!1,this._showAnalysisTypeSelect=!1,this._showPhotoUpload=!1,this._showPhotoReview=!1,this._showChatAssist=!1,this._showMissingLLMModal=!1,this._useSystemCapture=!1,this._systemCaptureReason=null}_toggleMetrics(){this._userToggledMetrics=!0,this._showMetrics=!this._showMetrics}render(){var l,r,o,c;let t=(r=(l=this.log)==null?void 0:l.food_entries)!=null?r:[],e=(c=(o=this.log)==null?void 0:o.exercise_entries)!=null?c:[],i=pt(this.selectedDate),a=e.length>0,s=t.length>0;return d`
    ...
    `}_renderMeasurementsSection(){var L,T,I,F,R,N,B,H,U,V,j,O,W,q,Z,Y,Q,G,J,K,X,tt;let t=(T=(L=this.profile)==null?void 0:L.attributes)!=null?T:{},e=t.weight_unit||"lbs",i=(I=this.log)==null?void 0:I.weight,a=t.current_weight,s=(F=i!=null?i:a)!=null?F:null,l=(R=this.log)==null?void 0:R.body_fat_pct,r=t.body_fat_percentage,o=(N=l!=null?l:r)!=null?N:null,c=(B=this.log)==null?void 0:B.bmr_and_neat,n=(U=(H=this.profile)==null?void 0:H.attributes)==null?void 0:U.bmr_and_neat,y=(V=c!=null?c:n)!=null?V:null,h=(O=(j=this.log)==null?void 0:j.macros)!=null?O:null,p=!!((q=(W=this.profile)==null?void 0:W.attributes)!=null&&q.track_macros),m=h?Number((Y=(Z=h.p)!=null?Z:h.protein)!=null?Y:0):0,_=h?Number((G=(Q=h.c)!=null?Q:h.carbs)!=null?G:0):0,x=h?Number((K=(J=h.f)!=null?J:h.fat)!=null?K:0):0,$=h?Number((tt=(X=h.a)!=null?X:h.alcohol)!=null?tt:0):0,v=m*4,A=_*4,C=x*9,P=$*7,S=v+A+C+P,z=S>0?Math.round(v/S*100):0,D=S>0?Math.round(A/S*100):0,M=S>0?Math.round(C/S*100):0,yt=S>0?Math.round(P/S*100):0,st=p,ot=d`
    ...
    `;return d`
      ${st?d`
        ...
        <div class="macro-line" style="margin-top:8px; font-size:0.98em; color: var(--secondary-text-color, #666);">
          Protein: ${m}g<span class="protein-percent">${z>0?` (${z}%)`:""}</span>&nbsp;&nbsp;&nbsp;Carbs: ${_}g<span class="carbs-percent">${D>0?` (${D}%)`:""}</span>&nbsp;&nbsp;&nbsp;Fat: <span class="fat-grams">${x}g${M>0?` (${M}%)`:""}</span><span class="fat-percent">${M>0?`${M}%`:"0%"}</span>
        </div>
      `:""}
    ...
    `}_renderEntry(t,e,i){var s,l,r,o;let a=ct(t.timestamp);return i==="exercise"?d`
        <li class="item">
          ...
          <button class="edit-btn" title="Edit" @click=${()=>this._openEdit(e,b(u({},t),{type:"exercise"}))}>
      ...
      `:d`
        <li class="item">
          ...
          <button class="edit-btn" title="Edit" @click=${()=>this._openEdit(e,b(u({},t),{type:"food"}))}>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.06,6.18L3,17.25V21H6.75L17.81,9.93L14.06,6.18Z" fill="#FFD700"/>
              <path d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87L20.71,7.04Z" fill="#FF6B6B"/>
            </svg>
    ...
    `}_openEdit(t,e){var a,s,l,r,o;let i="";if(e.timestamp){let c=new Date(e.timestamp),n=String(c.getHours()).padStart(2,"0"),y=String(c.getMinutes()).padStart(2,"0");i=`${n}:${y}`}e.type==="exercise"?this._editData=b(u({},e),{exercise_type:(a=e.exercise_type)!=null?a:"",duration_minutes:(s=e.duration_minutes)!=null?s:"",calories_burned:(l=e.calories_burned)!=null?l:0,time:i}):this._editData=u(u(u(u(b(u({},e),{food_item:(r=e.food_item)!=null?r:"",calories:(o=e.calories)!=null?o:0,time:i}),e.p!==void 0?{p:String(e.p)}:{}),e.c!==void 0?{c:String(e.c)}:{}),e.f!==void 0?{f:String(e.f)}:{}),e.a!==void 0?{a:String(e.a)}:{}),this._editIndex=t,this._showEditPopup=!0,this._editError=""}_closeEdit(){this._showEditPopup=!1,this._editIndex=-1,this._editData=null,this._editError=""}_onEditInput(t,e){let i=t.target.value;["p","c","f","a"].includes(e)&&(i=this._sanitizeDecimal(i),i!==t.target.value&&(t.target.value=i)),this._editData=b(u({},this._editData),{[e]:i}),this._editError=""}_onEditTimeInput(t){let e=t.target.value;this._editData=b(u({},this._editData),{time:e})}_saveEdit(){if(this._editData.type==="food"&&!this._validateMacroCalories(this._editData.calories,this._editData.p,this._editData.c,this._editData.f,this._editData.a,o=>{this._editError=o}))return;let t=this._editData.timestamp;if(this._editData.time&&this._editData.timestamp){let r=new Date(this._editData.timestamp),[o,c]=this._editData.time.split(":");r.setHours(Number(o)),r.setMinutes(Number(c)),r.setSeconds(0,0),t=dt(r)}let l=this._editData,{time:e,type:i}=l,a=et(l,["time","type"]),s;i==="exercise"?s={entry_id:this._editData.id,entry_type:"exercise",entry:b(u(b(u({},a),{timestamp:t}),this._editData.duration_minutes?{duration_minutes:Number(this._editData.duration_minutes)}:{}),{calories_burned:Number(this._editData.calories_burned)})}:s={entry_id:this._editData.id,entry_type:"food",entry:u(u(u(u(b(u({},a),{timestamp:t,calories:Number(this._editData.calories)}),this._isValidNumberStr(this._editData.p)?{p:Number(this._editData.p)}:{}),this._isValidNumberStr(this._editData.c)?{c:Number(this._editData.c)}:{}),this._isValidNumberStr(this._editData.f)?{f:Number(this._editData.f)}:{}),this._isValidNumberStr(this._editData.a)?{a:Number(this._editData.a)}:{})},this.dispatchEvent(new CustomEvent("edit-daily-entry",{detail:s,bubbles:!0,composed:!0})),this._closeEdit()}_renderEditPopup(){var e,i,a,s,l,r;let t=this._editData.type==="exercise";return d`
        ...
        <div class="modal-content photo-modal-content" @click=${_=>_.stopPropagation()}>
          <div class="photo-modal-shell">
            ...
            <div style="font-size:0.98em;margin-bottom:8px;">
              ...
              <div style="font-size:0.9em;opacity:0.8;">Title: ${(h=(y=this._selectedAnalyzer)==null?void 0:y.title)!=null?h:""}; Model: ${(m=(p=this._selectedAnalyzer)==null?void 0:p.model)!=null?m:"Unknown"}</div>
            </div>
            ${i?d`
              <div style="margin-bottom:10px;">
                <label style="font-size:0.98em;font-weight:500;display:block;margin-bottom:4px;">OPTIONAL: text description</label>
                <textarea class="edit-input" rows="3" style="font-size:1.05em;min-width:0;width:100%;resize:vertical;" placeholder="e.g. mashed potatoes with gravy under the steak, butter on broccoli" .value=${this._photoDescription||""} @input=${_=>{this._photoDescription=_.target.value}}></textarea>
              </div>
            `:""}
    ...
    `}_togglePhotoReviewItem(t,e){let i=[...this._photoReviewItems];i[t]=b(u({},i[t]),{selected:e.target.checked}),this._photoReviewItems=i}_editPhotoReviewItem(t,e,i){let a=[...this._photoReviewItems],s=["calories","p","f","c","a","percentage"],l=i.target.value;if(["p","c","f","c","a","percentage"].includes(e)&&e!=="calories"){let r=this._sanitizeDecimal(l);r!==l&&(i.target.value=r),a[t]=b(u({},a[t]),{[e]:r})}else s.includes(e)?a[t]=b(u({},a[t]),{[e]:l===""?void 0:Number(l)}):a[t]=b(u({},a[t]),{[e]:l});this._photoReviewItems=a}_confirmPhotoReview(){var e;if(!this._photoReviewItems||this._photoReviewItems.length===0){this._closePhotoReview();return}if(((e=this._photoReviewItems[0])==null?void 0:e.measurement_type)==="body_fat"){let i=this._photoReviewItems[0];if(!i.percentage||i.percentage<3||i.percentage>50){alert("Please enter a valid body fat percentage (3-50%)");return}let a=this.selectedDate;a||(a=E());let s=new Date,l=String(s.getHours()).padStart(2,"0"),r=String(s.getMinutes()).padStart(2,"0"),o=`${a}T${l}:${r}:00`;this.dispatchEvent(new CustomEvent("add-daily-entry",{detail:{entry_type:"body_fat",entry:{body_fat_percentage:Number(i.percentage),timestamp:o}},bubbles:!0,composed:!0}))}else{let i=this._photoReviewItems.filter(n=>n.selected&&n.food_item&&n.calories!==void 0);if(i.length===0){this._closePhotoReview();return}let a=[];for(let n of i){let y=[];this._validateMacroCalories(n.calories,n.p,n.c,n.f,n.a,p=>y.push(p),!0)||a.push({item:n,warn:y[0]})}if(a.length>0){alert(`One or more food items have calories from macros exceeding total calories. First issue: ${a[0].warn}`);return}let s=this.selectedDate;s||(s=E());let l=new Date,r=String(l.getHours()).padStart(2,"0"),o=String(l.getMinutes()).padStart(2,"0"),c=`${s}T${r}:${o}:00`;i.forEach((n,y)=>{this.dispatchEvent(new CustomEvent("add-daily-entry",{detail:{entry_type:"food",entry:u(u(u(u({food_item:n.food_item,calories:Number(n.calories),timestamp:c,analyzer:this._photoReviewAnalyzer,raw_result:this._photoReviewRaw},this._isValidNumberStr(n.p)?{p:Number(n.p)}:{}),this._isValidNumberStr(n.f)?{f:Number(n.f)}:{}),this._isValidNumberStr(n.c)?{c:Number(n.c)}:{}),this._isValidNumberStr(n.a)?{a:Number(n.a)}:{})},bubbles:!0,composed:!0}))})}this._closePhotoReview()}_renderPhotoProcessingModal(){return this._photoLoading?d`
...
//# sourceMappingURL=chunk-SB2JFX5E.js.map
