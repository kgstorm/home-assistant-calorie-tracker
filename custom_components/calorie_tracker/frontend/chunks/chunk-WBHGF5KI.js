...
<<<<<<<< HEAD:custom_components/calorie_tracker/frontend/chunks/chunk-GSRVJP7O.js
    `}_renderMeasurementsSection(){var L,T,I,F,R,N,B,H,V,U,j,O,W,q,Z,Y,K,Q,G,J,X,tt;let t=(T=(L=this.profile)==null?void 0:L.attributes)!=null?T:{},e=t.weight_unit||"lbs",i=(I=this.log)==null?void 0:I.weight,a=t.current_weight,s=(F=i!=null?i:a)!=null?F:null,n=(R=this.log)==null?void 0:R.body_fat_pct,l=t.body_fat_percentage,o=(N=n!=null?n:l)!=null?N:null,h=(B=this.log)==null?void 0:B.bmr_and_neat,r=(V=(H=this.profile)==null?void 0:H.attributes)==null?void 0:V.bmr_and_neat,y=(U=h!=null?h:r)!=null?U:null,p=(O=(j=this.log)==null?void 0:j.macros)!=null?O:null,c=!!((q=(W=this.profile)==null?void 0:W.attributes)!=null&&q.track_macros),m=p?Number((Y=(Z=p.p)!=null?Z:p.protein)!=null?Y:0):0,u=p?Number((Q=(K=p.c)!=null?K:p.carbs)!=null?Q:0):0,x=p?Number((J=(G=p.f)!=null?G:p.fat)!=null?J:0):0,A=p?Number((tt=(X=p.a)!=null?X:p.alcohol)!=null?tt:0):0,v=m*4,$=u*4,C=x*9,P=A*7,k=v+$+C+P,z=k>0?Math.round(v/k*100):0,D=k>0?Math.round($/k*100):0,M=k>0?Math.round(C/k*100):0,gt=k>0?Math.round(P/k*100):0,st=c,ot=d`
========
    `}_renderMeasurementsSection(){var L,T,I,F,R,N,B,H,U,V,j,O,W,q,Z,Y,Q,G,J,K,X,tt;let t=(T=(L=this.profile)==null?void 0:L.attributes)!=null?T:{},e=t.weight_unit||"lbs",i=(I=this.log)==null?void 0:I.weight,a=t.current_weight,s=(F=i!=null?i:a)!=null?F:null,l=(R=this.log)==null?void 0:R.body_fat_pct,r=t.body_fat_percentage,o=(N=l!=null?l:r)!=null?N:null,c=(B=this.log)==null?void 0:B.bmr_and_neat,n=(U=(H=this.profile)==null?void 0:H.attributes)==null?void 0:U.bmr_and_neat,y=(V=c!=null?c:n)!=null?V:null,h=(O=(j=this.log)==null?void 0:j.macros)!=null?O:null,g=!!((q=(W=this.profile)==null?void 0:W.attributes)!=null&&q.track_macros),u=h?Number((Y=(Z=h.p)!=null?Z:h.protein)!=null?Y:0):0,p=h?Number((G=(Q=h.c)!=null?Q:h.carbs)!=null?G:0):0,$=h?Number((K=(J=h.f)!=null?J:h.fat)!=null?K:0):0,A=h?Number((tt=(X=h.a)!=null?X:h.alcohol)!=null?tt:0):0,v=u*4,x=p*4,S=$*9,P=A*7,C=v+x+S+P,z=C>0?Math.round(v/C*100):0,D=C>0?Math.round(x/C*100):0,M=C>0?Math.round(S/C*100):0,yt=C>0?Math.round(P/C*100):0,st=g,ot=d`
>>>>>>>> a3760c6 (Added chat to deeplink):custom_components/calorie_tracker/frontend/chunks/chunk-WBHGF5KI.js
    ...
    `}_renderEntry(t,e,i){var s,n,l,o;let a=ct(t.timestamp);return i==="exercise"?d`
        <li class="item">
          ...
          <button class="edit-btn" title="Edit" @click=${()=>this._openEdit(e,b(g({},t),{type:"exercise"}))}>
      ...
      `:d`
        <li class="item">
          ...
          <button class="edit-btn" title="Edit" @click=${()=>this._openEdit(e,b(g({},t),{type:"food"}))}>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.06,6.18L3,17.25V21H6.75L17.81,9.93L14.06,6.18Z" fill="#FFD700"/>
              <path d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87L20.71,7.04Z" fill="#FF6B6B"/>
            </svg>
    ...
    `}_openEdit(t,e){var a,s,n,l,o;let i="";if(e.timestamp){let h=new Date(e.timestamp),r=String(h.getHours()).padStart(2,"0"),y=String(h.getMinutes()).padStart(2,"0");i=`${r}:${y}`}e.type==="exercise"?this._editData=b(g({},e),{exercise_type:(a=e.exercise_type)!=null?a:"",duration_minutes:(s=e.duration_minutes)!=null?s:"",calories_burned:(n=e.calories_burned)!=null?n:0,time:i}):this._editData=g(g(g(g(b(g({},e),{food_item:(l=e.food_item)!=null?l:"",calories:(o=e.calories)!=null?o:0,time:i}),e.p!==void 0?{p:String(e.p)}:{}),e.c!==void 0?{c:String(e.c)}:{}),e.f!==void 0?{f:String(e.f)}:{}),e.a!==void 0?{a:String(e.a)}:{}),this._editIndex=t,this._showEditPopup=!0,this._editError=""}_closeEdit(){this._showEditPopup=!1,this._editIndex=-1,this._editData=null,this._editError=""}_onEditInput(t,e){let i=t.target.value;["p","c","f","a"].includes(e)&&(i=this._sanitizeDecimal(i),i!==t.target.value&&(t.target.value=i)),this._editData=b(g({},this._editData),{[e]:i}),this._editError=""}_onEditTimeInput(t){let e=t.target.value;this._editData=b(g({},this._editData),{time:e})}_saveEdit(){if(this._editData.type==="food"&&!this._validateMacroCalories(this._editData.calories,this._editData.p,this._editData.c,this._editData.f,this._editData.a,o=>{this._editError=o}))return;let t=this._editData.timestamp;if(this._editData.time&&this._editData.timestamp){let l=new Date(this._editData.timestamp),[o,h]=this._editData.time.split(":");l.setHours(Number(o)),l.setMinutes(Number(h)),l.setSeconds(0,0),t=dt(l)}let n=this._editData,{time:e,type:i}=n,a=et(n,["time","type"]),s;i==="exercise"?s={entry_id:this._editData.id,entry_type:"exercise",entry:b(g(b(g({},a),{timestamp:t}),this._editData.duration_minutes?{duration_minutes:Number(this._editData.duration_minutes)}:{}),{calories_burned:Number(this._editData.calories_burned)})}:s={entry_id:this._editData.id,entry_type:"food",entry:g(g(g(g(b(g({},a),{timestamp:t,calories:Number(this._editData.calories)}),this._isValidNumberStr(this._editData.p)?{p:Number(this._editData.p)}:{}),this._isValidNumberStr(this._editData.c)?{c:Number(this._editData.c)}:{}),this._isValidNumberStr(this._editData.f)?{f:Number(this._editData.f)}:{}),this._isValidNumberStr(this._editData.a)?{a:Number(this._editData.a)}:{})},this.dispatchEvent(new CustomEvent("edit-daily-entry",{detail:s,bubbles:!0,composed:!0})),this._closeEdit()}_renderEditPopup(){var e,i,a,s,n,l;let t=this._editData.type==="exercise";return d`
    ...
    `}_togglePhotoReviewItem(t,e){let i=[...this._photoReviewItems];i[t]=b(g({},i[t]),{selected:e.target.checked}),this._photoReviewItems=i}_editPhotoReviewItem(t,e,i){let a=[...this._photoReviewItems],s=["calories","p","f","c","a","percentage"],n=i.target.value;if(["p","c","f","c","a","percentage"].includes(e)&&e!=="calories"){let l=this._sanitizeDecimal(n);l!==n&&(i.target.value=l),a[t]=b(g({},a[t]),{[e]:l})}else s.includes(e)?a[t]=b(g({},a[t]),{[e]:n===""?void 0:Number(n)}):a[t]=b(g({},a[t]),{[e]:n});this._photoReviewItems=a}_confirmPhotoReview(){var e;if(!this._photoReviewItems||this._photoReviewItems.length===0){this._closePhotoReview();return}if(((e=this._photoReviewItems[0])==null?void 0:e.measurement_type)==="body_fat"){let i=this._photoReviewItems[0];if(!i.percentage||i.percentage<3||i.percentage>50){alert("Please enter a valid body fat percentage (3-50%)");return}let a=this.selectedDate;a||(a=E());let s=new Date,n=String(s.getHours()).padStart(2,"0"),l=String(s.getMinutes()).padStart(2,"0"),o=`${a}T${n}:${l}:00`;this.dispatchEvent(new CustomEvent("add-daily-entry",{detail:{entry_type:"body_fat",entry:{body_fat_percentage:Number(i.percentage),timestamp:o}},bubbles:!0,composed:!0}))}else{let i=this._photoReviewItems.filter(r=>r.selected&&r.food_item&&r.calories!==void 0);if(i.length===0){this._closePhotoReview();return}let a=[];for(let r of i){let y=[];this._validateMacroCalories(r.calories,r.p,r.c,r.f,r.a,c=>y.push(c),!0)||a.push({item:r,warn:y[0]})}if(a.length>0){alert(`One or more food items have calories from macros exceeding total calories. First issue: ${a[0].warn}`);return}let s=this.selectedDate;s||(s=E());let n=new Date,l=String(n.getHours()).padStart(2,"0"),o=String(n.getMinutes()).padStart(2,"0"),h=`${s}T${l}:${o}:00`;i.forEach((r,y)=>{this.dispatchEvent(new CustomEvent("add-daily-entry",{detail:{entry_type:"food",entry:g(g(g(g({food_item:r.food_item,calories:Number(r.calories),timestamp:h,analyzer:this._photoReviewAnalyzer,raw_result:this._photoReviewRaw},this._isValidNumberStr(r.p)?{p:Number(r.p)}:{}),this._isValidNumberStr(r.f)?{f:Number(r.f)}:{}),this._isValidNumberStr(r.c)?{c:Number(r.c)}:{}),this._isValidNumberStr(r.a)?{a:Number(r.a)}:{})},bubbles:!0,composed:!0}))})}this._closePhotoReview()}_renderPhotoProcessingModal(){return this._photoLoading?d`
    ...
    `}_renderChatAssistModal(){var y,p;if(!this._showChatAssist)return"";let t=!1;if(this.hass&&this.hass.themes&&this.hass.selectedTheme){let c=this.hass.selectedTheme;t=((y=c==null?void 0:c.theme)==null?void 0:y.toLowerCase().includes("dark"))||(c==null?void 0:c.dark)===!0}else window.matchMedia&&(t=window.matchMedia("(prefers-color-scheme: dark)").matches);let e="var(--card-background-color)",i="var(--primary-text-color)",a="var(--divider-color)",s=t?"var(--ha-card-background, #23272e)":"var(--ha-card-background, #fafbfc)",n=this._isCompactDevice(),l=this._keyboardVisible,o=this._keyboardHeight||0,h="min(600px, 80vh)",r="400px";if(n&&l){let x=(((p=window.visualViewport)==null?void 0:p.height)||window.innerHeight)-60-40;h=`${Math.max(250,x)}px`,r="250px"}return d`
...
//# sourceMappingURL=chunk-WBHGF5KI.js.map
>>>>>>>> a3760c6 (Added chat to deeplink):custom_components/calorie_tracker/frontend/chunks/chunk-WBHGF5KI.js
