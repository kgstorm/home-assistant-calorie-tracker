import{a as it,b as d,g as at,h as lt}from"./chunk-EMR7U3YA.js";import{a as g,b,c as et,e as nt,g as _}from"./chunk-5HHMTMB7.js";var mt=nt(()=>{lt();function dt(f){let w=t=>String(t).padStart(2,"0");return`${f.getFullYear()}-${w(f.getMonth()+1)}-${w(f.getDate())}T${w(f.getHours())}:${w(f.getMinutes())}:${w(f.getSeconds())}`}function ct(f){if(!f)return"";let w=new Date(f),t=String(w.getHours()).padStart(2,"0"),e=String(w.getMinutes()).padStart(2,"0");return`${t}:${e}`}function ht(f){let[w,t,e]=f.split("-").map(Number);return new Date(w,t-1,e)}function M(f=new Date){let w=f.getFullYear(),t=String(f.getMonth()+1).padStart(2,"0"),e=String(f.getDate()).padStart(2,"0");return`${w}-${t}-${e}`}function pt(f){let w=f?ht(f):new Date;return`${w.getDate().toString().padStart(2,"0")} ${w.toLocaleString(void 0,{month:"short"})} ${w.getFullYear()}`}var ut=(f=24)=>d`
...
//# sourceMappingURL=chunk-EYQZ7XF2.js.map
