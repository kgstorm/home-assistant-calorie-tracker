import{a as L}from"./chunks/chunk-4E4HTHAA.js";import{b as I}from"./chunks/chunk-AVNE3KYX.js";import{a as z}from"./chunks/chunk-7BAGKXKT.js";import{a as S,b as c,g as $,h as C}from"./chunks/chunk-EMR7U3YA.js";import{a as m,b as D,e as E,f as x,g as _}from"./chunks/chunk-5HHMTMB7.js";var U=E(()=>{C();var R=x(L());I();var O=x(z());async function M(l){var p;return!(l!=null&&l.connection)||!((p=l==null?void 0:l.user)!=null&&p.id)?{}:await l.connection.sendMessagePromise({type:"calorie_tracker/get_user_profile",user_id:l.user.id})}function q(l=new Date){let p=l.getFullYear(),e=String(l.getMonth()+1).padStart(2,"0"),t=String(l.getDate()).padStart(2,"0");return`${p}-${e}-${t}`}var y=class extends ${constructor(){super();_(this,"_contentBounds",{left:0,width:0});_(this,"_contentResizeObserver",null);_(this,"_onHassReconnect",async()=>{await this._initializeProfile(),await this._fetchDiscoveredData()});_(this,"_onVisibilityChange",async()=>{if(document.visibilityState==="visible"){if(this._isLoading=!0,this.requestUpdate(),await this._ensureConnectionReady())try{await this._initializeProfile(),await this._fetchDiscoveredData()}catch(t){console.error("[CalorieTrackerPanel] Error refreshing data on visibility change:",t)}else console.warn("[CalorieTrackerPanel] Connection not ready after visibility change");this._isLoading=!1,this.requestUpdate()}});_(this,"_onProfileModalOpen",()=>{var t;this._profileModalDepth+=1;let e=(t=this.renderRoot)==null?void 0:t.querySelector("ha-card.main-card");e&&e.classList.add("profile-modal-active")});_(this,"_onProfileModalClose",()=>{var e;if(this._profileModalDepth=Math.max(0,this._profileModalDepth-1),this._profileModalDepth===0){let t=(e=this.renderRoot)==null?void 0:e.querySelector("ha-card.main-card");t&&t.classList.remove("profile-modal-active")}});this._hass=null,this._profile=null,this._allProfiles=[],this._selectedEntityId="",this._defaultProfile=null,this._discoveredData=[],this._imageAnalyzers=[];let e=new Date;this._selectedDate=q(e),this._showLinkDiscoveredPopup=!1,this._linkProfileId="",this._linkSelections={},this._goals=[],this._profileModalDepth=0,this._contentBounds={left:0,width:0},this._isLoading=!1,this._log={},this._weeklySummary={}}async _ensureConnectionReady(e=10,t=300){var i,a;for(let o=0;o<e;o++){if((a=(i=this._hass)==null?void 0:i.connection)!=null&&a.connected)try{return await this._hass.connection.sendMessagePromise({type:"get_config"}),!0}catch(s){console.debug("[CalorieTrackerPanel] Connection check failed, retrying...",s)}await new Promise(s=>setTimeout(s,t))}return console.warn("[CalorieTrackerPanel] Connection not ready after retries"),!1}async _fetchDiscoveredData(){var e,t;if(!((t=(e=this._hass)==null?void 0:e.connection)!=null&&t.connected)){this._discoveredData=[],this._imageAnalyzers=[],console.warn("[CalorieTrackerPanel] Connection not ready, skipping discovered data fetch");return}try{let i=await this._hass.connection.sendMessagePromise({type:"calorie_tracker/get_discovered_data"});this._discoveredData=(i==null?void 0:i.discovered_data)||[],this._imageAnalyzers=(i==null?void 0:i.image_analyzers)||[]}catch(i){this._discoveredData=[],this._imageAnalyzers=[],console.error("[CalorieTrackerPanel] Error fetching discovered data:",i)}this.requestUpdate()}set hass(e){this._hass=e,this.isConnected&&(this._initializeProfile(),this._fetchDiscoveredData())}connectedCallback(){super.connectedCallback(),this._hass&&(this._initializeProfile(),this._fetchDiscoveredData()),window.addEventListener("hass-reconnected",this._onHassReconnect),document.addEventListener("visibilitychange",this._onVisibilityChange),this.addEventListener("profile-modal-open",this._onProfileModalOpen),this.addEventListener("profile-modal-close",this._onProfileModalClose),this._checkForDeepLink(),requestAnimationFrame(()=>{var t;let e=(t=this.shadowRoot)==null?void 0:t.querySelector(".content");e&&(this._updateContentBounds(),this._contentResizeObserver=new ResizeObserver(()=>{this._updateContentBounds()}),this._contentResizeObserver.observe(e))})}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("hass-reconnected",this._onHassReconnect),document.removeEventListener("visibilitychange",this._onVisibilityChange),this.removeEventListener("profile-modal-open",this._onProfileModalOpen),this.removeEventListener("profile-modal-close",this._onProfileModalClose),this._contentResizeObserver&&(this._contentResizeObserver.disconnect(),this._contentResizeObserver=null)}_updateContentBounds(){var t;let e=(t=this.shadowRoot)==null?void 0:t.querySelector(".content");if(e){let i=e.getBoundingClientRect();this._contentBounds={left:i.left,width:i.width},this.requestUpdate()}}async _fetchProfileData(e,t=null){var i,a,o,s,r,h,d,f,v,w,b,P;try{if(!((i=this._hass)!=null&&i.connection)||!e)return{log:{},weight:null,weekly_summary:{},linked_components:{}};let[n,u,g,k]=await Promise.all([this._hass.connection.sendMessagePromise(m({type:"calorie_tracker/get_daily_data",entity_id:e},t?{date:t}:{})),this._hass.connection.sendMessagePromise(m({type:"calorie_tracker/get_weekly_summary",entity_id:e},t?{date:t}:{})),this._hass.connection.sendMessagePromise({type:"calorie_tracker/get_linked_components",entity_id:e}),this._hass.connection.sendMessagePromise({type:"calorie_tracker/get_goals",entity_id:e})]);return{log:{food_entries:(a=n==null?void 0:n.food_entries)!=null?a:[],exercise_entries:(o=n==null?void 0:n.exercise_entries)!=null?o:[],weight:(s=n==null?void 0:n.weight)!=null?s:null,body_fat_pct:(r=n==null?void 0:n.body_fat_pct)!=null?r:null,bmr_and_neat:(h=n==null?void 0:n.bmr_and_neat)!=null?h:null,macros:(d=n==null?void 0:n.macros)!=null?d:{},config_entry_id:(f=n==null?void 0:n.config_entry_id)!=null?f:null},weight:(v=n==null?void 0:n.weight)!=null?v:null,weekly_summary:(w=u==null?void 0:u.weekly_summary)!=null?w:{},linked_components:(b=g==null?void 0:g.linked_components)!=null?b:{},goals:(P=k==null?void 0:k.goals)!=null?P:[]}}catch(n){if(n&&(n.code===403||n.status===403)){window.location.href="/";return}throw n}}async _initializeProfile(){var e,t;if(!((t=(e=this._hass)==null?void 0:e.connection)!=null&&t.connected)){console.warn("[CalorieTrackerPanel] Connection not ready, skipping profile initialization");return}try{let i=await M(this._hass);this._defaultProfile=(i==null?void 0:i.default_profile)||null,this._allProfiles=(i==null?void 0:i.all_profiles)||[];let a=this._selectedEntityId;if((!a||!this._allProfiles.some(o=>o.entity_id===a))&&(i!=null&&i.default_profile&&i.default_profile.entity_id?a=i.default_profile.entity_id:this._allProfiles.length>0?a=this._allProfiles[0].entity_id:a=""),this._selectedEntityId=a,this._selectedEntityId){let{log:o,weight:s,weekly_summary:r,linked_components:h,goals:d}=await this._fetchProfileData(this._selectedEntityId,this._selectedDate);this._log=o,this._weight=s,this._weeklySummary=r,this._linkedComponents=h,this._goals=d}else this._log={},this._weight=null,this._weeklySummary={},this._linkedComponents={},this._goals=[]}catch(i){this._defaultProfile=null,this._allProfiles=[],this._selectedEntityId="",this._log={},this._weight=null,this._weeklySummary={},this._linkedComponents={},this._goals=[],console.error("[CalorieTrackerPanel] Failed to fetch user profile:",i)}this._selectProfile(),this.requestUpdate()}async _checkForDeepLink(){try{let e=new URLSearchParams(window.location.search||window.location.hash.replace(/^#/,"?")),t=e.get("modal"),i=e.get("profile")||e.get("entity_id")||e.get("config_entry_id");if(!t)return;if(i)if(this._allProfiles&&this._allProfiles.length){let a=i,o=(a||"").trim().toLowerCase(),s=this._allProfiles.find(r=>r.entity_id===a||r.config_entry_id===a||r.entity_id===`profile.${a}`);if(!s){let r=d=>(d||"").toString().trim().toLowerCase().replace(/[\s_-]+/g,""),h=r(o);s=this._allProfiles.find(d=>{if(!d.spoken_name)return!1;let f=d.spoken_name.toString().trim().toLowerCase();return f===o||r(f)===h})}s&&(this._selectedEntityId=s.entity_id,await this._fetchProfileData(this._selectedEntityId,this._selectedDate),this._selectProfile(),this.requestUpdate())}else{setTimeout(()=>this._checkForDeepLink(),250);return}setTimeout(()=>this._openCameraOnLoad(t),300),this._clearModalParam()}catch(e){console.warn("[CalorieTrackerPanel] deep-link check failed",e)}}_openCameraOnLoad(e){var t;try{let i=(t=this.renderRoot)==null?void 0:t.querySelector("daily-data-card");i&&typeof i._openPhotoAnalysis=="function"?(i._openPhotoAnalysis(),e&&setTimeout(()=>{try{e==="food_camera"&&typeof i._selectAnalysisType=="function"?i._selectAnalysisType("food"):e==="bodyfat_camera"&&typeof i._selectAnalysisType=="function"&&i._selectAnalysisType("bodyfat")}catch(a){}},250)):i?i.dispatchEvent(new CustomEvent("open-photo-analysis",{detail:{modal:e},bubbles:!0,composed:!0})):setTimeout(()=>this._openCameraOnLoad(e),200)}catch(i){console.warn("[CalorieTrackerPanel] failed to open camera modal on load",i)}}_clearModalParam(){try{let e=new URL(window.location.href),t=e.searchParams;if(t.has("modal")){t.delete("modal");let i=`${e.pathname}${t.toString()?`?${t.toString()}`:""}${e.hash}`;window.history.replaceState({},document.title,i)}}catch(e){}}_selectProfile(){if(!this._hass||!this._allProfiles.length){this._profile=null,this._selectedEntityId="";return}let e=this._selectedEntityId;(!e||!this._allProfiles.some(t=>t.entity_id===e))&&(e=this._allProfiles[0].entity_id),this._selectedEntityId=e,this._profile=this._hass.states[e]||null}_openLinkDiscoveredPopup(){this._linkProfileId=this._allProfiles.length>0?this._allProfiles[0].entity_id:"",this._linkSelections=Object.fromEntries((this._discoveredData||[]).map(e=>[e.entry_id,!0])),this._showLinkDiscoveredPopup=!0}_closeLinkDiscoveredPopup(){this._showLinkDiscoveredPopup=!1}_onLinkProfileChange(e){this._linkProfileId=e.target.value}_onLinkSelectionChange(e,t){this._linkSelections=D(m({},this._linkSelections),{[t]:e.target.checked})}async _saveLinkSelections(){var i;if(!((i=this._hass)!=null&&i.connection)||!this._linkProfileId)return;let e=Object.entries(this._linkSelections).filter(([a,o])=>o).map(([a,o])=>{let s=(this._discoveredData||[]).find(r=>r.entry_id===a);return s?{linked_domain:s.domain,linked_component_entry_id:s.entry_id}:null}).filter(Boolean);if(e.length===0){this._showSnackbar&&this._showSnackbar("No devices selected",!0);return}let t={};for(let{linked_domain:a,linked_component_entry_id:o}of e)t[a]||(t[a]=[]),t[a].push(o);try{for(let[a,o]of Object.entries(t))await this._hass.connection.sendMessagePromise({type:"calorie_tracker/link_discovered_components",calorie_tracker_entity_id:this._linkProfileId,linked_domain:a,linked_component_entry_ids:o});this._showSnackbar&&this._showSnackbar("Devices linked"),this._showLinkDiscoveredPopup=!1,this._fetchDiscoveredData(),this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:a,weight:o,weekly_summary:s,linked_components:r,goals:h})=>{this._log=a,this._weight=o,this._weeklySummary=s,this._linkedComponents=r||{},this._goals=h||[],this.requestUpdate()}).catch(a=>{console.error("Failed to refresh profile data after linking:",a)})}catch(a){this._showSnackbar&&this._showSnackbar("Failed to link devices",!0)}}_renderLinkDiscoveredPopup(){let e=this._allProfiles;return c`
    ...
    `}render(){var e,t,i,a,o,s,r,h,d,f;return c`
      <ha-app-layout>
            ...
            <ha-card class="main-card">
              <div class="card-content">
                <profile-card
                  ...
                  .dailyGoal=${((a=(i=this._weeklySummary)==null?void 0:i[this._selectedDate])==null?void 0:a[3])||null}
                  .currentWeight=${((s=(o=this._weeklySummary)==null?void 0:o[this._selectedDate])==null?void 0:s[5])||null}
              ...
              <div class="card-content">
                ${this._profile?c`
                      <calorie-summary
                        ...
                        .weight=${this._weight}
                        .weekStartDay=${((f=(d=this._profile)==null?void 0:d.attributes)==null?void 0:f.week_start_day)||"sunday"}
    ...
    `}_toggleSidebar(e){e.preventDefault(),e.stopPropagation();let t=document.querySelector("home-assistant");if(!(t!=null&&t.shadowRoot))return;let i=t.shadowRoot.querySelector("home-assistant-main");if(!(i!=null&&i.shadowRoot))return;let a=i.shadowRoot.querySelector("ha-sidebar");a&&typeof a.toggle=="function"&&a.toggle()}_onSelectSummaryDate(e){let t=e.detail.date;this._selectedDate=t,this._fetchProfileData(this._selectedEntityId,t).then(({log:i,weight:a,weekly_summary:o})=>{this._log=i,this._weight=a,this._weeklySummary=o,this.requestUpdate()})}_onProfileSelected(e){this._selectedEntityId=e.detail.entityId,this._selectProfile(),this._profile&&this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:t,weight:i,weekly_summary:a,linked_components:o,goals:s})=>{this._log=t,this._weight=i,this._weeklySummary=a,this._linkedComponents=o||{},this._goals=s||[],this.requestUpdate()})}_onRefreshProfile(e){this._selectedEntityId&&this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:t,weight:i,weekly_summary:a,linked_components:o,goals:s})=>{this._log=t,this._weight=i,this._weeklySummary=a,this._linkedComponents=o||{},this._goals=s||[],this.requestUpdate()}).catch(t=>{console.error("Failed to refresh profile data:",t)})}_onEditDailyEntry(e){var o;let{entry_id:t,entry_type:i,entry:a}=e.detail;!((o=this._hass)!=null&&o.connection)||!this._selectedEntityId||this._hass.connection.sendMessagePromise({type:"calorie_tracker/update_entry",entity_id:this._selectedEntityId,entry_id:t,entry_type:i,entry:a}).then(()=>{this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:s,weekly_summary:r})=>{this._log=s,this._weeklySummary=r,this.requestUpdate()}).catch(s=>{console.error("Failed to refresh profile data after update:",s)})}).catch(s=>{console.error("Failed to update entry:",s)})}_onDeleteDailyEntry(e){var a;let{entry_id:t,entry_type:i}=e.detail;!((a=this._hass)!=null&&a.connection)||!this._selectedEntityId||this._hass.connection.sendMessagePromise({type:"calorie_tracker/delete_entry",entity_id:this._selectedEntityId,entry_id:t,entry_type:i}).then(()=>{this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:o,weekly_summary:s})=>{this._log=o,this._weeklySummary=s,this.requestUpdate()}).catch(o=>{console.error("Failed to refresh profile data after delete:",o)})}).catch(o=>{console.error("Failed to delete entry:",o)})}_onRefreshSummary(){this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:e,weight:t,weekly_summary:i})=>{this._log=e,this._weight=t,this._weeklySummary=i,this.requestUpdate()})}_onRefreshDailyData(){this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:e,weight:t,weekly_summary:i})=>{this._log=e,this._weight=t,this._weeklySummary=i,this.requestUpdate()})}_onAddDailyEntry(e){var a;let{entry_type:t,entry:i}=e.detail;!((a=this._hass)!=null&&a.connection)||!this._selectedEntityId||this._hass.connection.sendMessagePromise({type:"calorie_tracker/create_entry",entity_id:this._selectedEntityId,entry_type:t,entry:i}).then(()=>{this._fetchProfileData(this._selectedEntityId,this._selectedDate).then(({log:o,weight:s,weekly_summary:r})=>{this._log=o,this._weight=s,this._weeklySummary=r,this.requestUpdate()}).catch(o=>{console.error("Failed to refresh profile data after add:",o)})}).catch(o=>{console.error("Failed to add entry:",o)})}_onGoalsUpdated(e){var t;!((t=this._hass)!=null&&t.connection)||!this._selectedEntityId||this._hass.connection.sendMessagePromise({type:"calorie_tracker/get_goals",entity_id:this._selectedEntityId}).then(i=>{this._goals=(i==null?void 0:i.goals)||[],this.requestUpdate()}).catch(i=>{console.error("Failed to refresh goals:",i)})}};_(y,"styles",[S`
      :host {
